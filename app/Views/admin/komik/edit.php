...
<div class="row mt-4">
    ...
    <div class="row mt-4">
        <div class="col">
            <h2 class="my-4">Edit Comic Data Form</h2>

            <form action="/admin/update_komik/<?= $komik['id']; ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea name="sinopsis" id="sinopsis" class="form-control <?= ($validation->hasError('sinopsis')) ? 'is-invalid' : ''; ?>" value="<?= (old('sinopsis')) ? old('sinopsis') : $komik['sinopsis'] ?>" cols="30" rows="5">
                            <?= (old('sinopsis')) ? old('sinopsis') : $komik['sinopsis'] ?>
                        </textarea>
                        <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="col">
                        <button type="submit" class="button primary-button btn float-end">Edit Data</button>
                    </div>
                </div>
            </form>
        </div>
